...
export default function ResetPassword() {
  ...
  // استخراج التوكن وuserId وكلمة المرور القديمة المشفرة من الـ URL
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // إرسال الطلب إلى الخادم مع التوكن في الهيدر
      await axios.post(
        `${API_BASE_URL}/users/reset-password`,
        { newPassword: password, id: userId, token: token } // البيانات المرسلة
      );

      router.push("/"); // تحويل إلى الصفحة الرئيسية عند النجاح
    } catch (error) {
